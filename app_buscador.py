...
# Panel de Entrada
with st.container():
    producto = st.text_input("¿Qué buscamos hoy, socio?", placeholder="Ej: Queso para untar, Resina, BTC...")
